...
mtext(side=1,line=-1.5,cex=1,"Data: New Zealand’s Greenhouse Gas Inventory 1990 – 2022 MfE 2024 Report ME 1824 \nTime-series-emissions-data-in-AR4-1990-to-2022-from-NZGHGI-2024.xlsx")
mtext(side=3,cex=1.5, line=-2,expression(paste("New Zealand aviation emissions 1990 to 2022")) )
